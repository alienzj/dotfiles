...
in {
  ...
  config = {
    ...
    home-manager = {
      ...
      # files easily to my $HOME, but 'home-manager.users.alienzj.home.file.*'
      # is much too long and harder to maintain, so I've made aliases in:
      #
      #   home.file        ->  home-manager.users.alienzj.home.file
      #   home.configFile  ->  home-manager.users.alienzj.home.xdg.configFile
      #   home.dataFile    ->  home-manager.users.alienzj.home.xdg.dataFile
